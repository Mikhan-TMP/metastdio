...
const AvatarGestureEmotionUI = () => {
  ...
  useEffect(() => {
    const fetchGesturesAndEmotions = async () => {
      try {
        const gesturesData = [
          { _id: "67ecb062a3754ed719f5ceb7", name: "wave", description: "A greeting or goodbye hand wave", emoji: "👋" },
          { _id: "67ecb062a3754ed719f5ceb8", name: "point", description: "Pointing with the index finger", emoji: "☝️" },
          { _id: "67ecb062a3754ed719f5ceb9", name: "clap", description: "Applauding by clapping hands", emoji: "👏" },
          { _id: "67ecb063a3754ed719f5ceba", name: "thumbs up", description: "Approval or agreement", emoji: "👍" },
          { _id: "67ecb063a3754ed719f5cebb", name: "handshake", description: "Shaking hands as a greeting", emoji: "🤝" },
          { _id: "67ecb063a3754ed719f5cebc", name: "thinking", description: "A thoughtful gesture", emoji: "🤔" },
          { _id: "67ecb063a3754ed719f5cebd", name: "explain", description: "Hand movements to explain something", emoji: "🗣️" },
          { _id: "67ecb063a3754ed719f5cebe", name: "arms crossed", description: "Crossing arms in confidence or defiance", emoji: "🙅" },
          { _id: "67ecb063a3754ed719f5cebf", name: "check watch", description: "Looking at the wristwatch", emoji: "⌚" },
          { _id: "67ecb064a3754ed719f5cec0", name: "nodding", description: "Nodding in agreement", emoji: "🙆" },
          { _id: "67ecb064a3754ed719f5cec1", name: "shrug", description: "Indicating uncertainty or indifference", emoji: "🤷" },
          { _id: "67ecb064a3754ed719f5cec2", name: "head tilt", description: "Tilting head in curiosity or confusion", emoji: "🤨" },
        ];

        const emotionsData = [
          { _id: "67ecb0e7a3754ed719f5cec3", name: "Happy", description: "A feeling of joy and positivity", emoji: "😊" },
          { _id: "67ecb0e7a3754ed719f5cec4", name: "Sad", description: "A feeling of sorrow or unhappiness", emoji: "😢" },
          { _id: "67ecb0e7a3754ed719f5cec5", name: "Surprised", description: "A sudden reaction of amazement or shock", emoji: "😲" },
          { _id: "67ecb0e7a3754ed719f5cec6", name: "Angry", description: "A strong feeling of displeasure or rage", emoji: "😠" },
          { _id: "67ecb0e8a3754ed719f5cec7", name: "Neutral", description: "A calm and indifferent expression", emoji: "😐" },
          { _id: "67ecb0e8a3754ed719f5cec8", name: "Excited", description: "A high-energy feeling of enthusiasm", emoji: "😃" },
          { _id: "67ecb0e8a3754ed719f5cec9", name: "Confused", description: "Uncertainty or lack of understanding", emoji: "😕" },
          { _id: "67ecb0e8a3754ed719f5ceca", name: "Concerned", description: "A feeling of worry or care", emoji: "😟" },
          { _id: "67ecb0e8a3754ed719f5cecb", name: "Confident", description: "A strong belief in oneself", emoji: "😎" },
          { _id: "67ecb0e8a3754ed719f5cecc", name: "Thoughtful", description: "A pensive or reflective mood", emoji: "🤔" },
        ];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="p-4 bg-white shadow rounded-lg mb-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <select className="bg-white border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-[#9B25A7] focus:border-transparent focus:outline-none">
              {avatars.map((avatar) => (
        ...
        <div className="flex-1 min-h-0 flex flex-col">
          <div className="flex-1 flex">
            ...
            <div className="w-1/3 p-4 bg-white shadow rounded-lg flex flex-col">
              <h3 className="font-medium mb-4 text-[#9B25A7]">Camera Views</h3>
