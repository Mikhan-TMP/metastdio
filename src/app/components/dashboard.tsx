...
const Page = () => {
  ...
  const navigationItems = [
    ...
    },
    {
      id: "user",
      label: username,
      icon: username !== "Login/Signup" ? Users : LogIn,
        ...
        <div className="min-h-screen bg-gray-100">
          ...
          <nav className="bg-white shadow-sm p-2 sticky top-0 z-50 w-full flex justify-content-between">
            <div className="max-w-1xl mx-auto px-4 flex p-4 items-center h-16">
              {/* Logo */}
              <img src="http://www.meta-town.io/Metacity/assets/Flexor/assets/img/metatown.png" alt="MetaTown Logo" className="h-8 w-auto pe-10 cursor-pointer" onClick={() => router.push('/')} />
