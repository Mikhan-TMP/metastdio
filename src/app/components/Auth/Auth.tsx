...
return (
    ...
    <div className="flex flex-row items-center justify-center w-full">
        ...
        ">
        {/* LOGO */}
        <img src="/metatown.png" alt="Metatown" width={250} height={150} className="absolute z-99 top-10 mx-auto md:pt-12 md:pr-24 md:top-0 md:right-0 cursor-pointer" onClick={() => router.push('/')}/>
